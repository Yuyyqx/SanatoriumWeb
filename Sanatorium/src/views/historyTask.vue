      ...
      <div class="content">
        <div class="nowPage">
          ...
          <label style="color: #888888"
            >每日任务 / <label style="color: #63cda5">历史任务</label></label
          >
        </div>
        ...
        <div class="manage">
          ...
          <div class="managePic">
            <div class="managePic2">
              <label><label class="label1">历史任务</label></label>
              <el-scrollbar class="conscorll">
                ...
                >
                  ...
                  <el-table-column prop="people" label="操作员" width="180">
                  </el-table-column>
                  <el-table-column prop="assign" label="指派对象" width="120">
                  </el-table-column>
