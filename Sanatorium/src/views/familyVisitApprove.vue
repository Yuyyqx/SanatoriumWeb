      ...
      <div class="content">
        <div class="nowPage">
          ...
          <label style="color: #888888"
            >审批申请 / 家属 /
            <label style="color: #63cda5">处理访客信息</label></label
          >
        </div>
        ...
        <el-scrollbar class="conscorll">
          <div class="wholeList">
            ...
            >
              ...
              <div class="itemTitle">
                {{ item.familyName }}提交的2021年家属访客申请
              </div>
              <div class="beginTime">申请时间：{{ item.startTime }}</div>
              <div class="endTime">结束时间：{{ item.endTime }}</div>
            </div>
          </div>
        </el-scrollbar>
    ...
    <span>
      <div class="detailMain">
          <div class="detailMainTop">
              <div style="font-weight: 600;padding-left:10px;">{{detailInfo.nurseName}}提交的2021年家属访客申请</div>
          ...
          <div class="otherInfo">
              ...
              <div class="applyId">
                  <div class="applyIdLabel">开始时间：</div>
                  <div>{{detailInfo.startTime}}</div>
              </div>
              <div class="applyId">
                  <div class="applyIdLabel">结束时间：</div>
...
export default {
  ...
  data() {
    return {
      ...
      approveList: [
        {
          ...
          familyName: "李青莲",
          oldName: "王小虎",
          startTime: "2021-11-25 09:47",
          endTime: "2021-11-27 09:47",
          reason: "",
          state: "未审批",
        },
        {
        ...
        },
        {
          ...
          familyName: "张小红",
          oldName: "王建国",
          startTime: "2021-11-25 09:55",
          endTime: "2021-11-27 09:55",
          reason: "",
          state: "未审批",
        },
        {
        ...
        },
        {
          ...
          familyName: "郑集",
          oldName: "李某某",
          startTime: "2021-11-23 13:47",
          endTime: "2021-11-25 13:47",
          reason: "",
          state: "已审批",
        },
        {
          ...
          familyName: "殷正",
          oldName: "赵某某",
          startTime: "2021-11-22 16:31",
          endTime: "2021-11-24 16:31",
          reason: "",
          state: "未审批",
        },
        {
          ...
          familyName: "吕长征",
          oldName: "陈某某",
          startTime: "2021-11-25 07:25",
          endTime: "2021-11-27 13:25",
          reason: "",
          state: "未审批",
        },
        {
          ...
          familyName: "秦含章",
          oldName: "李某某",
          startTime: "2021-11-26 13:10",
          endTime: "2021-11-29 13:10",
          reason: "",
          state: "已审批",
        },
        {
          ...
          familyName: "满平",
          oldName: "赵某某",
          startTime: "2021-11-25 13:49",
          endTime: "2021-11-27 13:49",
          reason: "",
          state: "未审批",
        },
        {
      ...
      illustrate: "各位家长：提交访客申请需要提前准备好核酸检测报告。【1】进入疗养院的访客，需严格遵守疗养院的规矩。审批疗养院通过，才可成功进入疗养院。【2】晚8点后不得进入疗养院（特殊情况除外）。当天访问需在规定时间内进入（特殊情况请及时向疗养院说明）【3】若发现未按时进入疗养院，弄虚作假造成严重后果的，按照疫情期间的管理规定作出相应处理。特别提醒：此轮疫情已波及多个省市，请注意非必要不外出。",
