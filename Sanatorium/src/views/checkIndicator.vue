      ...
      <div class="content">
        <div class="nowPage">
          ...
          <label style="color: #888888"
            >健康状况 /
            <label style="color: #63cda5">查看各项指标</label></label
          >
        </div>
        ...
        <div class="maincontent">
          <div class="maincontentleft">
            <el-table class="maintable" :data="tableData">
              ...
              <el-table-column prop="build" label="楼号" width="100">
              </el-table-column>
              <el-table-column prop="room" label="房间" width="140">
              </el-table-column>
              <el-table-column prop="grade" label="护理等级" width="140">
              </el-table-column>
              <el-table-column prop="score" label="评级健康" width="140">
              </el-table-column>
