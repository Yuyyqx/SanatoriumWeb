      ...
      <div class="content">
        <div class="nowPage">
          ...
          <label style="color: #888888"
            >核心信息管理 /
            <label style="color: #63cda5">摄像头设备信息</label></label
          >
        </div>
        ...
        <div class="graphList">
          <div class="maincontentleft">
            <el-table class="maintable" :data="tableData">
              ...
              <el-table-column prop="range" label="量测范围" width="120">
              </el-table-column>
              <el-table-column prop="useConditon" label="使用状况" width="120">
              </el-table-column>
              <el-table-column prop="san" label="使用疗养院" width="140">
              </el-table-column>
