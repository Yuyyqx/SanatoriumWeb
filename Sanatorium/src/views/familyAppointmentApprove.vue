      ...
      <div class="content">
        <div class="nowPage">
          ...
          <label style="color: #888888"
            >审批申请 / 家属 /
            <label style="color: #63cda5">处理预约信息</label></label
          >
        </div>
        ...
        <el-scrollbar class="conscorll">
          <div class="wholeList">
            ...
            >
              ...
              <div class="itemTitle">
                {{ item.nurseName }}提交的2021年家属预约申请
              </div>
              <div class="beginTime">申请时间：{{ item.startTime }}</div>
              <div class="endTime">护工疗号：{{ item.nurseId }}</div>
            </div>
          </div>
        </el-scrollbar>
    ...
    <span>
      <div class="detailMain">
          <div class="detailMainTop">
              <div style="font-weight: 600;padding-left:10px;">{{detailInfo.nurseName}}提交的2021年家属预约申请</div>
